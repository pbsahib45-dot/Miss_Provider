...
PICS = (environ.get('PICS', 'https://files.catbox.moe/v7gyev.jpg')).split()  # Sample pic
...
# ============================
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '5193286986').split()] # Replace with the actual admin ID(s) to add
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1003656099780').split()]  # Channel id for auto indexing (make sure bot is admin)

LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1003723046443'))  # Log channel id (make sure bot is admin)
BIN_CHANNEL = int(environ.get('BIN_CHANNEL', '-1003881168706'))  # Bin channel id (make sure bot is admin)
PREMIUM_LOGS = int(environ.get('PREMIUM_LOGS', '-1003723046443'))  # Premium logs channel id
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-5040049360')  # Support group id (make sure bot is admin)
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1003846155587')  # Request channel id (make sure bot is admin)
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/+m3luQ1O68d1jMWNl')  # Support group link (make sure bot is admin)

# FORCE_SUB 
auth_req_channels = environ.get("AUTH_REQ_CHANNELS", "-1001618427298")# requst to join Channel for force sub (make sure bot is admin) only for bot ADMINS  
auth_channels     = environ.get("AUTH_CHANNELS", "-1002240859605")# Channels for force sub (make sure bot is admin)

# ============================
# Payment Configuration
# ============================
QR_CODE = environ.get('QR_CODE', 'https://files.catbox.moe/t13imo.jpg')    # QR code image for payments
OWNER_UPI_ID = environ.get('OWNER_UPI_ID', 'parwindersingh3077@okaxis')    # Owner UPI ID for payments
...
# ============================
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://Filmygram47:Filmygram47@filmygram47.uuqstsj.mongodb.net/?appName=Filmygram47")  # MongoDB URI But Dont Use Its Not Working And Banned Words
DATABASE_NAME = environ.get('DATABASE_NAME', "Filmygram47") # Database name (default: cluster)
...
MOVIE_UPDATE_CHANNEL = int(environ.get('MOVIE_UPDATE_CHANNEL', '-1003825810095'))  # Notification of sent to your channel
...
TMDB_API_KEY = environ.get('TMDB_API_KEY', 'ee820997394177424392a06486adb3c5') # preffer to use your own tmdb API Key get it from https://www.themoviedb.org/settings/api
...
LOG_VR_CHANNEL = int(environ.get('LOG_VR_CHANNEL', '-1003598163136')) #Verification Channel Id 
LOG_API_CHANNEL = int(environ.get('LOG_API_CHANNEL', '-1003598163136')) #If Anyone Set Your Bot In Any Group And Set Shortner In That Group Then In This Channel The All Details Come
VERIFY_IMG = environ.get("VERIFY_IMG", "https://files.catbox.moe/yn5axo.jpg")

TUTORIAL = environ.get("TUTORIAL", "https://t.me/howtoopenlinks44/10")   # Tutorial link for verification
TUTORIAL_2 = environ.get("TUTORIAL_2", "https://t.me/howtoopenlinks44/10")   # Second tutorial link for verification
TUTORIAL_3 = environ.get("TUTORIAL_3", "https://t.me/howtoopenlinks44/10")   # Third tutorial link for verification

# Verification (Must Fill All Veriables. Else You Got Error
SHORTENER_API = environ.get("SHORTENER_API", "77abe6a44fae06cb15acc5c7fe09d3d8483dcb19") # Shortener API key
SHORTENER_WEBSITE = environ.get("SHORTENER_WEBSITE", "nowshort.com") # Shortener website

SHORTENER_API2 = environ.get("SHORTENER_API2", "77abe6a44fae06cb15acc5c7fe09d3d8483dcb19")  # Shortener API key for second website
SHORTENER_WEBSITE2 = environ.get("SHORTENER_WEBSITE2", "nowshort.com") # Shortener website for second website

SHORTENER_API3 = environ.get("SHORTENER_API3", "77abe6a44fae06cb15acc5c7fe09d3d8483dcb19")  
SHORTENER_WEBSITE3 = environ.get("SHORTENER_WEBSITE3", "nowshort.com") # Shortener website for third website
...
# ============================
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/filmygraph4') # Group link for the bot
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/Jox_444') # Owner link for the bot
UPDATE_CHNL_LNK = environ.get('UPDATE_CHNL_LNK', 'https://t.me/updatefilmx') # Update channel link for the bot

# ============================
# User Configuration
# ============================
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '5193286986').split()]
AUTH_USERS = (auth_users + ADMINS) if auth_users else []
PREMIUM_USER = [int(user) if id_pattern.search(user) else user for user in environ.get('PREMIUM_USER', '5193286986').split()]
...
QUALITIES = ["360P", "480P", "720P", "1080P", "1440P", "2160P", "4K","8K","16K"]
