...
async def start(client, message):
    ...
    if len(message.command) != 2:
        ...
        if curr_time < 12:
            ...
            gtxt = "ɢᴏᴏᴅ ɴɪɢʜᴛ 🌑"
        m=await message.reply_sticker("CAACAgUAAxkBAAEPfjdo38uP92MVJVpc3LEh0dkX22xImAACmBsAArgc4FZ2eoAAATCPVYw2BA")
    ...
    if not files_:
        ...
        try:
            ...
            k = await msg.reply(
                f"<b><u>❗️❗️❗️ ɪᴍᴘᴏʀᴛᴀɴᴛ ❗️❗️❗️</u></b>\n\n"

f"📂 ᴛʜɪꜱ ꜰɪʟᴇ / ᴠɪᴅᴇᴏ ᴡɪʟʟ ʙᴇ ᴅᴇʟᴇᴛᴇᴅ ɪɴ <b><u><code>{get_time(DELETE_TIME)}</code></u></b> ⏳\n"
f"<i>(ᴅᴜᴇ ᴛᴏ ᴄᴏᴘʏʀɪɢʜᴛ ɪꜱꜱᴜᴇꜱ)</i>\n\n"

"⚠️ <b><i>ᴘʟᴇᴀꜱᴇ ꜰᴏʀᴡᴀʀᴅ ⏩ ᴛʜɪꜱ ꜰɪʟᴇ ᴛᴏ ʏᴏᴜʀ ꜱᴀᴠᴇᴅ ᴍᴇꜱꜱᴀɢᴇꜱ ᴏʀ ᴀɴʏ ꜰʀɪᴇɴᴅ ᴀɴᴅ ꜱᴛᴀʀᴛ ᴅᴏᴡɴʟᴏᴀᴅɪɴɢ.</i></b>\n\n"

"━━━━━━━━━━━━━━━━━━━━\n\n"

"✍️ <b>ɴᴏᴛᴇ (ʜɪɴᴅɪ)</b> :\n"
"ऊपर दिया गया फाइल <b>1 मिनट</b> में डिलीट हो जाएगा ⏳\n\n"

"👉 कृपया इस फाइल को अपने <b>Sᴀᴠᴇᴅ Mᴇssᴀɢᴇs</b> या किसी दोस्त को Fᴏʀᴡᴀʀᴅ ⏩ कर लें।",
                quote=True
            )
            await asyncio.sleep(DELETE_TIME)
            await msg.delete()
    ...
    if STREAM_MODE and not PREMIUM_STREAM_MODE:
        ...
        if not await db.has_premium_access(message.from_user.id):
            ...
            btn = [
                [InlineKeyboardButton('✦ 𝐖𝐚𝐭𝐜𝐡 𝐎𝐧𝐥𝐢𝐧𝐞/𝐅𝐚𝐬𝐭 𝐃𝐨𝐰𝐧𝐥𝐨𝐚𝐝 ✦🖥️', callback_data=f'generate_stream_link:{file_id}')],
                [InlineKeyboardButton('◈ 𝐉𝐨𝐢𝐧 𝐔𝐩𝐝𝐚𝐭𝐞𝐬 𝐂𝐡𝐚𝐧𝐧𝐞𝐥 ◈', url=UPDATE_CHNL_LNK)]  # Keep this line unchanged  
            ]
    else:
        btn = [[InlineKeyboardButton('◈ 𝐉𝐨𝐢𝐧 𝐔𝐩𝐝𝐚𝐭𝐞𝐬 𝐂𝐡𝐚𝐧𝐧𝐞𝐥 ◈', url=UPDATE_CHNL_LNK)]]
